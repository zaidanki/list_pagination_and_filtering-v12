...
const showPage = (list, page) => { // function to make sure only 10 people are displayed at a time.
...
const appendPageLinks = (list) => { // fucntion that appends the elements needed to create a numbering pagination
...
a[0].className = 'active'} else {
 ...
 div.addEventListener('click', (e) =>{  // event that listens for clicks on the numbers and changes the students displayed accordingly
...
const searchinput = () => { // a function that searches names and compares them using the indexOf method and if it returns a number bigger than -1 then it is displayed
